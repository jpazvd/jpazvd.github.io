...
# GitHub Pages compatible Jekyll version# GitHub Pages compatible Jekyll version

gem "github-pages", "~> 232", group: :jekyll_pluginsgem "github-pages", "~> 232", group: :jekyll_plugins



# Jekyll Scholar for academic bibliography (requires GitHub Actions for full functionality)# Jekyll Scholar for academic bibliography (requires GitHub Actions for full functionality)

gem "jekyll-scholar", "~> 7.0"gem "jekyll-scholar", "~> 7.0"



# Additional plugins for caching and theme support# Additional plugins for caching and theme support

gem "jekyll-include-cache", "~> 0.2"gem "jekyll-include-cache", "~> 0.2"



# Windows and JRuby timezone handling# Windows and JRuby timezone handling

platforms :mingw, :x64_mingw, :mswin, :jruby doplatforms :mingw, :x64_mingw, :mswin, :jruby do
...
# Performance booster for Windows# Performance booster for Windows

gem "wdm", "~> 0.1.1", :platforms => [:mingw, :x64_mingw, :mswin]gem "wdm", "~> 0.1.1", :platforms => [:mingw, :x64_mingw, :mswin]



# JRuby http parser lock# JRuby http parser lock
