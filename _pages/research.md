...
permalink: /research/
author_profile: true
description: "Research by João Pedro Azevedo on Learning Poverty, Human Capital measurement, education economics, and poverty measurement."
---
...
Work on building the data architecture for the World Bank's global poverty monitoring, including the harmonization of over 1,200 household surveys, development of PovcalNet/PIP, DATALIBWEB, and leadership of the Data for Goals initiative and the Global Solution Group on Welfare Measurement and Statistical Capacity.

**Selected Work:**
- 📝 [Is Poverty Seasonal?](https://blogs.worldbank.org/en/developmenttalk/poverty-seasonal) (Blog, 2016)
- 📝 [How persistent is poverty in the short run?](https://blogs.worldbank.org/en/developmenttalk/how-persistent-poverty-short-run) (Blog, 2016)
...
**Selected Software:**
- 💻 [WBOPENDATA](https://ideas.repec.org/c/boc/bocode/s457234.html) — Access World Bank databases from Stata ([ssc install wbopendata](https://github.com/worldbank/wbopendata))
- 💻 [SAE / FHSAE](https://ideas.repec.org/c/boc/bocode/s458418.html) — Small area estimation: unit- and area-level models
